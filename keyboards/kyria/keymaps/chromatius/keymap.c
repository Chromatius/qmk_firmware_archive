...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_WORKMAN] = LAYOUT(
        TG(_WORKMANMAC), KC_Q,     KC_D,     KC_R,     KC_W,         KC_B,                                                                                                      KC_J,              KC_F,          KC_U,        KC_P,      SE_ARNG,   SE_ADIA,
        KC_BSPACE,       HOME_A,   HOME_S,   HOME_H,   HOME_T,       KC_G,                                                                                                      KC_Y,              HOME_N,        HOME_E,      HOME_O,    HOME_I,    SE_ODIA,
        TG(_GAMING),     KC_Z,     HOME_X,   KC_M,     KC_C,         KC_V,                TERMINAL,           LT(_MEDIA, KC_NO),      MUTE,             KC_NO,                  KC_K,              KC_L,          KC_COMM,     HOME_DOT,  SE_MINS,   SE_APOS,
                                             KC_NO,    KC_ESCAPE,    MO(_SYMBOLSRIGHT),  LT(_NAV, KC_SPACE), KC_DELETE,              LT(_FN, KC_TAB),  LT(_NUMPAD, KC_ENTER),  MO(_SYMBOLSLEFT), OSM(MOD_RSFT), KC_PSCREEN
    ),

    [_GAMING] = LAYOUT(
        KC_ESCAPE,       KC_Q,     KC_D,     KC_R,     KC_W,         KC_B,                                                                                          KC_J,              KC_F,          KC_U,        KC_P,      SE_ARNG,   SE_ADIA,
        KC_TAB,          KC_A,     KC_S,     KC_H,     KC_T,         KC_G,                                                                                          KC_Y,              HOME_N,        HOME_E,      HOME_O,    HOME_I,    SE_ODIA,
        KC_TRANSPARENT,  KC_Z,     HOME_X,   KC_M,     KC_C,         KC_V,                KC_F6,              KC_F7,      MUTE,             KC_NO,                  KC_K,              KC_L,          KC_COMM,     HOME_DOT,  SE_MINS,   SE_APOS,
                                             KC_F2,    KC_F3,        KC_F4,               KC_SPACE,           KC_F5,      LT(_FN, KC_TAB),  LT(_NUMPAD, KC_ENTER),  MO(_SYMBOLSLEFT), OSM(MOD_RSFT), KC_PSCREEN
    ),

    [_WORKMANMAC] = LAYOUT(
        KC_TRANSPARENT, KC_Q,     KC_D,     KC_R,     KC_W,         KC_B,                                                                                           KC_J,                 KC_F,          KC_U,        KC_P,      SE_ARNG,   SE_AT_MAC,
        KC_BSPACE,      HOME_A,   HOME_S,   HOME_H,   HOME_T,       KC_G,                                                                                           KC_Y,                 HOME_N,        HOME_E,      HOME_O,    HOME_I,    SE_ODIA,
        KC_LSFT,        KC_Z,     HOME_X,   KC_M,     KC_C,         KC_V,                  TERMINAL,           KC_TRNS,    KC_NO,            KC_NO,                 KC_K,                 KC_L,          KC_COMM,     HOME_DOT,  SE_MINS,   SE_APOS,
                                            MUTE_MAC, KC_ESCAPE,    MO(_SYMBOLSRIGHTMAC), LT(_NAV, KC_SPACE), KC_DELETE,  LT(_FN, KC_TAB),  LT(_NUMPAD, KC_ENTER), MO(_SYMBOLSLEFTMAC), OSM(MOD_RSFT), KC_PSCREEN
    ),
